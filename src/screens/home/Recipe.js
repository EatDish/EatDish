      ...
      <View
        ...
        <View style={styles.infoContainer}>
          <View style={styles.infoRow}>
            <Text style={{ ...styles.dishName, color: colors.text }}>{`${recipe.dishName} `}</Text>
            <Text style={{ ...styles.cuisine, color: colors.text }}>{recipe.cuisine}</Text>
          </View>
          <View style={styles.infoRow}>
            <Text
              style={{
          ...
          <View style={styles.infoRow}>
            <Text
              style={{ ...styles.details, color: colors.text }}>{`Stars: ${recipe.stars} `}</Text>
            <Text
              style={{ ...styles.details, color: colors.text }}>{`Forks: ${recipe.forks}`}</Text>
          </View>
        </View>
        <View style={styles.infoContainer}>
          <TouchableOpacity
            ...
            <View style={styles.headerContainer}>
              ...
              <Text style={{ ...styles.header, color: colors.text }}>Ingredients</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.infoContainer}>
          <TouchableOpacity
            ...
            <View style={styles.headerContainer}>
              ...
              <Text style={{ ...styles.header, color: colors.text }}>Instructions</Text>
            </View>
          </TouchableOpacity>
          {showInstructions && (
            <Text style={{ ...styles.instructions, color: colors.text }}>{mappedInstructions}</Text>
          )}
        </View>
      </View>
    </ScrollView>
